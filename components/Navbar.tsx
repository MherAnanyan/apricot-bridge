...
export default function Navbar() {
  ...
  const links = [
    ...
    { label: tripsLabel, href: "/#packages" },
  ...
  return (
    <nav
      ...
      style={{
        ...
        borderBottom: "0.5px solid rgba(200,160,120,0.2)",
      }}
    >
      <div className="max-w-7xl mx-auto px-4 lg:px-16 flex items-center justify-between gap-2">
        ...
        >
          ...
          >
            <svg width="20" height="20" viewBox="0 0 22 22" fill="none">
              ...
              />
              <path
                d="M11 2 Q14.5 0 17 2 Q16 5.5 13 5.5 Q12 5 11 2"
                fill="#3B6B2A"
              />
              <path
                d="M11 8 Q9.5 10 9.5 13"
                stroke="#C45A0A"
                strokeWidth="1"
                strokeLinecap="round"
              />
          ...
          <div className="min-w-0">
            <div
              className="font-playfair font-semibold leading-tight whitespace-nowrap"
              style={{ color: "#2C1810", fontSize: "clamp(14px,4vw,18px)" }}
            >
              Apricot{" "}
              <span
                style={{
            ...
            <div
              ...
              style={{ color: "#8C8078", marginTop: "-1px" }}
            >
              Armenia
            </div>
          </div>
        ...
        <div className="hidden md:flex items-center gap-5 flex-shrink-0">
          ...
          <a
            href="/#contact"
            className="text-sm font-medium rounded-full px-5 py-2 whitespace-nowrap flex-shrink-0"
            style={{
              background: "#E8721A",
              color: "white",
              textDecoration: "none",
            ...
            onMouseEnter={(e) =>
              ((e.currentTarget as HTMLElement).style.background = "#C45A0A")
            }
            onMouseLeave={(e) =>
              ((e.currentTarget as HTMLElement).style.background = "#E8721A")
            }
          >
            {t.nav.cta}
          </a>
      ...
      {menuOpen && (
        <div
          ...
          style={{ borderTop: "0.5px solid rgba(200,160,120,0.2)" }}
        >
          {links.map((l) => (
            <Link
              key={l.label}
              href={l.href}
              className="text-sm py-3 block"
              style={{
                color: "#5C3D2E",
                textDecoration: "none",
                borderBottom: "0.5px solid rgba(200,160,120,0.15)",
              }}
